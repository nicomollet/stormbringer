...
function thememylogin_shortcode_lostpassword() {
  return  do_shortcode('[theme-my-login default_action="lostpassword" show_title=0 login_template="form-login.php" register_template="form-register.php" lostpassword_template="form-lostpassword.php" resetpass_template="form-resetpass.php" profile_template="form-profile.php"]');
}
add_shortcode('form-lostpassword', 'thememylogin_shortcode_lostpassword');

function thememylogin_shortcode_register() {
  return  do_shortcode('[theme-my-login default_action="register" show_title=0 login_template="form-login.php" register_template="form-register.php" lostpassword_template="form-lostpassword.php" resetpass_template="form-resetpass.php" profile_template="form-profile.php"]');
}
add_shortcode('form-register', 'thememylogin_shortcode_register');

function thememylogin_shortcode_login() {
  return  do_shortcode('[theme-my-login default_action="login" show_title=0 login_template="form-login.php" register_template="form-register.php" lostpassword_template="form-lostpassword.php" resetpass_template="form-resetpass.php" profile_template="form-profile.php"]');
}
add_shortcode('form-login', 'thememylogin_shortcode_login');

function thememylogin_shortcode_resetpass() {
  return  do_shortcode('[theme-my-login default_action="resetpass" show_title=0 login_template="form-login.php" register_template="form-register.php" lostpassword_template="form-lostpassword.php" resetpass_template="form-resetpass.php" profile_template="form-profile.php"]');
}
add_shortcode('form-resetpass', 'thememylogin_shortcode_resetpass');

function thememylogin_shortcode_profile() {
  return  do_shortcode('[theme-my-login default_action="profile" show_title=0 login_template="form-login.php" register_template="form-register.php" lostpassword_template="form-lostpassword.php" resetpass_template="form-resetpass.php" profile_template="form-profile.php"]');
}
...
function stormbringer_thememylogin_default_options(){
  $args = array(
...
function stormbringer_thememylogin_the_title( $title, $post_id = 0 ) {
  ...
  if ( $theme_my_login->is_login_page( $post_id ) ) {
    //print 'aaa';
  //if ( !in_the_loop() ) {
  //  $title = is_user_logged_in() ? __( 'Log Out555', 'theme-my-login' ) : __( 'Log In666', 'theme-my-login' );
  //} else {
...
function stormbringer_thememylogin_setup_nav_menu_item( $menu_item ) {
  ...
  $args = apply_filters( 'thememylogin_options', stormbringer_thememylogin_default_options() );
