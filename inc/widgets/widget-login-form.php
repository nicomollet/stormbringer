...
add_action('widgets_init', create_function('', 'return register_widget("alienship_Widget_Login");'));

function alienship_register_widget_login() {

  /* Register the login form widget */
  register_widget( 'alienship_Widget_Login' );
}
add_action( 'widgets_init', 'alienship_register_widget_login' );
