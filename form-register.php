...
<form name="form-register" id="form-register<?php $template->the_instance(); ?>" action="<?php $template->the_action_url('register'); ?>" method="post" class="form-horizontal form-register">
  ...
  <div class="form-group">
    <label class="control-label" for="userlogin<?php $template->the_instance(); ?>"><?php _e('Nom d\'utilisateur', 'stormbringer') ?></label>
		<div class="form-input">
			<input placeholder="<?php _e('Nom d\'utilisateur', 'stormbringer') ?>" type="text" name="user_login" id="userlogin<?php $template->the_instance(); ?>" class="form-control" value="<?php $template->the_posted_value('user_login'); ?>"/>
		</div>
  </div>
  ...
  <div class="form-group">
    <label class="control-label" for="useremail-<?php $template->the_instance(); ?>"><?php _e('E-mail', 'stormbringer') ?></label>
	  ...
	  <div class="help-block"><?php _e('Un mot de passe vous sera envoyé par e-mail', 'stormbringer'); ?></div>
  </div>
  ...
  <div class="form-group">
	  <div class="form-actions">
		  <input class="btn btn-primary" type="submit" name="form-submit" id="form-submit<?php $template->the_instance(); ?>" value="<?php _e('Créer le compte', 'stormbringer'); ?>"/>
