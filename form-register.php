...
<form name="form-register" id="form-register<?php $template->the_instance(); ?>" action="<?php $template->the_action_url('register'); ?>" method="post" class="form-horizontal form-register">
  ...
  <div class="form-group">
    <label class="control-label" for="useremail-<?php $template->the_instance(); ?>"><?php _e('Email', 'stormbringer') ?></label>
		<div class="form-input">
			<input placeholder="<?php _e('Email', 'stormbringer') ?>" type="text" name="user_email" id="useremail<?php $template->the_instance(); ?>" class="form-control" value="<?php $template->the_posted_value('user_email'); ?>"/>
		</div>
	  <div class="help-block"><?php _e('A password will be sent to your email.', 'stormbringer'); ?></div>
  </div>
  ...
  <div class="form-group">
	  <div class="form-actions">
		  <input class="btn btn-primary" type="submit" name="form-submit" id="form-submit<?php $template->the_instance(); ?>" value="<?php _e('Create an account', 'stormbringer'); ?>"/>
  ...
  <div class="movetomodal-footer">
    <p class="pull-right">
      <?php
      _e('Already have an account?','stormbringer'); print'&nbsp;';
