...
<form name="form-lostpassword" id="form-lostpassword-<?php $template->the_instance(); ?>" action="<?php $template->the_action_url('lostpassword'); ?>" method="post" class="form-horizontal form-lostpassword">
  ...
  <div class="control-group">
    <label class="control-label" for="userlogin-<?php $template->the_instance(); ?>"><?php _e('Username or E-mail:', 'theme-my-login') ?></label>

    <div class="controls">
      <input placeholder="<?php _e('Username or E-mail:', 'theme-my-login') ?>" type="text" name="user_login" id="userlogin-<?php $template->the_instance(); ?>" class="input-small" value="<?php $template->the_posted_value('user_login'); ?>"/>
    </div>
  </div>
  ...
  <div class="form-actions">
    <input class="btn btn-primary" type="submit" name="wp-submit" id="wp-submit<?php $template->the_instance(); ?>" value="<?php _e('Get New Password', 'theme-my-login'); ?>"/>
