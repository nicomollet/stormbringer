...
<div class="modal hide fade do-not-print modal-gallery" id="modal-gallery" tabindex="-1" aria-hidden="true">
  ...
  <div class="modal-footer">
    ...
    <a class="btn btn-info modal-prev"><i class="icon-arrow-left icon-white"></i> <?php _e("Précédent","stormbringer"); ?></a>
    <a class="btn btn-success modal-play modal-slideshow" data-slideshow="5000"><i class="icon-play icon-white"></i> <?php _e("Diaporama","stormbringer"); ?></a>
